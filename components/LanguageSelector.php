...
class LanguageSelector implements BootstrapInterface
{
    ...
    public function bootstrap($app)
    {
        ...
        if($languageNew !== null)
        {
            if(!in_array($languageNew, $this->supportedLanguages)) { // ตรวจสอบว่า language
                throw new Exception('Invalid your selected language'); // ถ้ามี language ในรายการ ก็ exception
            }

            $cookies->add(new Cookie([
                'name' => 'language',
                'value' => $languageNew,
                'expire' => time() + 60 + 60 * 24 * 30, // 30 วัน
        ...
        else 
        {
            ...
            $app->language = $preferedLanguage; // กำหนดภาษาเริ่มต้นให้ app ในนี้คือ th-TH
        }
    }
}
?>