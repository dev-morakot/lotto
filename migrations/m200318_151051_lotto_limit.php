...
/**
 * Class m200318_151051_lotto_limit
 */
class m200318_151051_lotto_limit extends Migration
{
    ...
    {
        $this->createTable('res_jan_lotto_limit', [
            'id' => $this->primaryKey(),
    ...
    {
        $this->dropTable('res_jan_lotto_limit');
        return false;
    }
    ...
    {
        echo "m200318_151051_lotto_limit cannot be reverted.\n";
