...
use app\modules\sale\models\SaleOrderLineSearch;

/**
 * SaleOrderController implements the CRUD actions for PurchaseOrder model.
 */
class SaleOrderLineController extends ActiveController {

    public $modelClass = "app\modules\sale\models\SaleOrderLine";
