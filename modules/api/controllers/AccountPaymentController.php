 ...
 */
class AccountPaymentController extends ActiveController {

    public $modelClass = "app\modules\account\models\AccountPayment";
    ...
    public function actionSearch(){
        ...
        $searchModel = new \app\modules\account\models\AccountPaymentSearch();
