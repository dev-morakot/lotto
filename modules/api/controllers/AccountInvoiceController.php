 ...
 */
class AccountInvoiceController extends ActiveController {

    public $modelClass = "app\modules\account\models\AccountInvoice";
    ...
    public function actionSearch(){
        ...
        $searchModel = new \app\modules\account\models\AccountInvoiceSearch();
