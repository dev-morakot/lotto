 ...
 */
class AccountProductGroupController extends ActiveController {

    public $modelClass = "app\modules\account\models\AccountProductGroup";
    ...
    public function actionSearch(){
        ...
        $searchModel = new \app\modules\account\models\AccountProductGroup();
