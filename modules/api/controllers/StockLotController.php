 ...
 */
class StockLotController extends ActiveController {

    public $modelClass = "app\modules\stock\models\StockLot";
    ...
    public function actionSearch(){
        ...
        $searchModel = new \app\modules\stock\models\StockLotSearch();
    ...
    public function actionFind(){
        $queryParams = Yii::$app->request->queryParams;
        Yii::info(['queryparams**',$queryParams]);
        $stockLots = \app\modules\stock\models\StockLot::find()
                ->andFilterWhere(['name'=>@$queryParams['name']])
                ->andFilterWhere(['product_id'=>@$queryParams['product_id']])
                ->all();
        return $stockLots;
    }
}
