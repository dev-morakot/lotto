 ...
 */
class ProductSupplierinfoController extends ActiveController {

    public $modelClass = "app\modules\product\models\ProductSupplierinfo";
    ...
    public function actionSearch(){
        ...
        $searchModel = new \app\modules\product\models\ProductSupplierinfoSearch();
        $searchModel->attributes = $queryParams;
        $dataProvider = $searchModel->search([]);
        
        Yii::info(['count**',count($searchModel)]);
        return $dataProvider;
    }
}
