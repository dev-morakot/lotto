 ...
 */
class AccountTaxController extends ActiveController {

    public $modelClass = "app\modules\account\models\AccountTax";
    ...
    public function actionSearch(){
        ...
        $searchModel = new \app\modules\account\models\AccountTaxSearch();
